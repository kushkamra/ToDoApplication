...
window.onload = function () { 
    ...
    {
        document.getElementById("loggedinUser").innerText =  JSON.parse(sessionStorage.getItem("userdata")).email ;
...
function validateUser(un, pw) {
    ...
    let result = false;
            try {
                ...
                if(userList != null) {
                    var userdata =  userList.find( a  => a.email ==  un.toLowerCase());
                    ...
                    if(userdata) 
                    {
                     ...
                     var password = Base64.decode(userdata.password);
                     console.log(password);
                     if ((un.toLowerCase() == username) && (pw == password)) {
